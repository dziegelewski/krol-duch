...
function unitsStrike () {
	...
	function chancesForCriticalHit () {
		...
		if (ifPerform('irydion')) {
			if (losuj(0,10000) < merc[7].amount) {
				console.log('yup')
